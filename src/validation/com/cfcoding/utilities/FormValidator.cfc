...
<cfcomponent name="FormValidator" output="false">
	...
	<cfset variables.settings.errors['valid_email'] = 'The [LABEL] field is not a valid email address.'>
    ...
    <cffunction name="boolean" access="public" output="false" returntype="boolean">
    	<cfargument name="value" type="string" required="true" />
		<cfargument name="argument" type="string" required="true" />
		<cfargument name="field" type="string" required="true" />
        
        <cfreturn listFindNoCase("0,1,false,true,no,yes", lcase(arguments.value)) GT 0 />
    </cffunction>
